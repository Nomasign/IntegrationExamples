...
2. **Send a Document** — call `POST /api/templates/send` (with `templateId` plus recipient details and field values in the body). NomaSign creates a signing session and emails the document to the signer.
